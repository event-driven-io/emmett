...
```typescript
import { isNode, isBrowser, isBun, isDeno, isWebWorker, isJsDom } from '@event-driven-io/emmett-shims';
...
```typescript
import type { ReadableStream, WritableStream, TransformStream } from '@event-driven-io/emmett-shims';
```
