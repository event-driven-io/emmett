...
import { zipEventStoreDBEventStoreMessageBatchPullerStartFrom } from './index';

void describe('zipEventStoreDBEventStoreMessageBatchPullerStartFrom', () => {
  void it('starts from the earliest checkpoint when processors are seeded differently', () => {
    ...
    const result = zipEventStoreDBEventStoreMessageBatchPullerStartFrom([
