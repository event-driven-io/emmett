 ...
 */
export type ProjectionQueries<T extends StreamType> = {
...
export type MongoDBStreamAsDocumentEventStoreOptions = {
  ...
  DefaultEventStoreOptions<MongoDBStreamAsDocumentEventStore>;

export type MongoDBStreamAsDocumentEventStore =
...
export class MongoDBStreamAsDocumentEventStoreImplementation
  implements MongoDBStreamAsDocumentEventStore, Closeable
{
  ...
  private options: MongoDBStreamAsDocumentEventStoreOptions;
  public projections: ProjectionQueries<StreamType>;

  constructor(options: MongoDBStreamAsDocumentEventStoreOptions) {
  ...
  async appendToStream<EventType extends Event>(
    ...
    await tryPublishMessagesAfterCommit<MongoDBStreamAsDocumentEventStore>(
      eventsToAppend,
      this.options.hooks,
      // {
