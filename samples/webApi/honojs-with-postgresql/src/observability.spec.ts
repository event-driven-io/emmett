 ...
 *
 * 5. PinoInstrumentation ESM hook doesn't intercept pino in tsx + Node 24.
 ...
 *
 * 6. Tempo and Loki ports (3200, 3100) not exposed in docker-compose.yml.
 *    Fix: added explicit `ports` entries to both services.
 *
 * 7. Restarting Tempo or Loki gives them new internal IPs. The OTel collector
 *    caches the old gRPC address. Fix: restart the collector after recreating
 *    any downstream service.
 *
 * 8. Stale cart state causes 400 on add-product: a confirmed/cancelled cart
