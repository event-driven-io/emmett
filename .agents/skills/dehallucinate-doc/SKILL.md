...
Before restructuring, load the **`docs-writer`** skill (`.agents/skills/docs-writer/SKILL.md`) and follow its Diátaxis guidance. Read the page's front-matter `documentationType`, then match a sibling of the _same_ type before you touch it:
