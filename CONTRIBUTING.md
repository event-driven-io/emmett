...
We use coding agents while working on Emmett, but Emmett isn't vibe-coded. We combine regular coding with agent-assisted work. Every change is designed, reviewed, and validated by a person who understands it and takes responsibility for it.
